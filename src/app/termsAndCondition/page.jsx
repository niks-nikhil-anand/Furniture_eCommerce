...
const TermsAndConditions = () => {
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <p>
        By accessing this website we assume you accept these terms and conditions. Do not continue to use The Royal Oak
      ...
      <p>
        Unless otherwise stated, The Royal Oak and/or its licensors own the intellectual property rights for all
        material on The Royal Oak. All intellectual property rights are reserved. You may access this from The Royal Oak
        for your own personal use subjected to restrictions set in these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul className="list-disc pl-8">
        <li>Republish material from The Royal Oak</li>
        <li>Sell, rent or sub-license material from The Royal Oak</li>
        <li>Reproduce, duplicate or copy material from The Royal Oak</li>
        <li>Redistribute content from The Royal Oak</li>
      </ul>
      ...
      <h2 className="text-2xl font-bold mt-8 mb-4">Hyperlinking to our Content</h2>

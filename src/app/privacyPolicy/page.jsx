  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      <div className="bg-white p-6 shadow-lg rounded-lg">
        ...
        <p className="text-gray-600 mb-4">Last updated: April 23, 2024</p>
        ...
        <h2 className="text-3xl font-bold mb-4">Tracking Technologies and Cookies</h2>
      ...
      <div className="bg-white p-6 shadow-lg rounded-lg">
        ...
        <h2 className="text-3xl font-bold mb-4">Disclosure of Your Personal Data</h2>
        ...
        <h2 className="text-3xl font-bold mb-4">Security of Your Personal Data</h2>
        <p className="mb-4">
          We implement reasonable and appropriate security measures to protect Your Personal Data from unauthorized access, alteration, disclosure, or destruction.
        </p>
      </div>
    </div>
  );
